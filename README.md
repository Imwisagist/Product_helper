![example workflow](https://github.com/imwisagist/foodgram-project-react/actions/workflows/main.yml/badge.svg)
...
```
git clone git@github.com:imwisagist/foodgram-project-react.git
```
